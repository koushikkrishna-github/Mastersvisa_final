				 	...
				 	<div class="headtoppart bg-white clearfix">
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo"><a href="#hero-8" class="logo-black"><img src="images/brand/logo.png" width="250" height="60" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="#hero-8" class="logo-white"><img src="images/brand/logo.png" width="250" height="60" alt="header-logo"></a></div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-12">
							<div class="cta-txt text-center">
								<h4 class="h4-xs txt-400">Need immigration & visa consultation? <a href="mailto:info@mastersvisa.com">Send a request</a> for free consultation</h4>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-md-12 section-title center">		
			 				...
			 				<!-- Title -->
							<h2 class="h2-xs darkblue-color">ImmiEx Immigration Services</h2>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-7 col-xl-6">
							<div class="about-4-txt mb-40">
								...
								<!-- Button -->
								<a href="tel:+91 9133855571" class="btn btn-md btn-primary black-hover">
									Call: +12 9 8765 4321
								</a>
