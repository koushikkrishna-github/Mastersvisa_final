...
<body>
								...
								<div class="contact-box icon-xs clearfix">
									...
									<div class="contact-box-txt">
										<h5 class="h5-xs deepblue-color"><a
												href="mailto:info@mastersvisa.com">info@mastersvisa.com</a></h5>
										<h5 class="h5-xs deepblue-color"><a
												href="mailto:info@mastersvisa.com">career@domain.com</a></h5>
							...
							<div class="form-holder">
								<form name="contactForm" class="row contact-form">
									...
									<div id="input-subject" class="col-lg-12 input-subject">
										<select id="inlineFormCustomSelect2" name="subject"
											class="custom-select subject" required>
								...
								<form class="newsletter-form">
									...
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button type="submit"
												class="btn btn-primary tra-black-hover">Subscribe</button>
										</span>
									</div>
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCUQmwdDWm3cQXhPqIO9TsKHq7hrvh2XrU&callback=initMap"
		async defer></script>
